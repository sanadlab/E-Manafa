...
class HunterParser(object):
    """Class that parses traces in log files generated by a custom method_traces plugin.

    This class parses method traces contained in log files generated by a custom method_traces plugin.
    ...
    def add_cpu_consumption_to_trace_file(self, filename, functions, instrument=False):
        new_filename = filename.replace(os.path.basename(filename), os.path.basename(filename).replace("method_traces-", "truncated_hunter-"))
